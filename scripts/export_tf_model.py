...
trained_checkpoint_prefix = 'checkpoint_.ckpt'
...
model.load(trained_checkpoint_prefix)

with model.session as sess:
    # Export checkpoint to SavedModel
    builder = tf.saved_model.builder.SavedModelBuilder(export_dir)

    signature = tf.saved_model.signature_def_utils.predict_signature_def(inputs={'in':NetworkIN}, outputs={'out':Network})
